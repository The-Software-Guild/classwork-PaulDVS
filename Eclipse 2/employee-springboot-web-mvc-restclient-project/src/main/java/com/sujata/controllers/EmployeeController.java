...
//	}
	...
	public ModelAndView getAllEmployeesController() {
		...
		EmployeeList employees=employeeService.getAllEmployees();
	...
	public String updateSalaryPageController() {
		return "updateSalary";
	}
	
	@RequestMapping("/updateSalary")
	public ModelAndView updateSalaryController(@RequestParam("empId") int id, @RequestParam("empSalary") int newSal) {
		ModelAndView modelAndView=new ModelAndView();
		
		String message=null;
		if(employeeService.updateEmployeeSalById(id, newSal))
			message="Employee Salary Update Successfully";
		else
			message="Employee Salary Update Failed";
