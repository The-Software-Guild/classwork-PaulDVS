...
public class EmployeeResource {
	...
	@PutMapping(path = "/employees/{id}/{newSal}",produces = MediaType.APPLICATION_JSON_VALUE)
	public Employee updateSalaryById(@PathVariable int id, @PathVariable int newSal) {
		return employeeService.updateSalary(id, newSal);
	}
}
